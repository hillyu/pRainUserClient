...
public class DeviceListAdapter extends BaseAdapter {
	...
	private ArrayList<BTDeviceListItem> mDevices;
	...
	public DeviceListAdapter(Activity par) {
		super();
		mDevices  = new ArrayList<BTDeviceListItem>();
		mRecords = new ArrayList<byte[]>();
		mRSSIs = new ArrayList<Integer>();
		mInflater = par.getLayoutInflater();
	}
	
	public void addDevice(BTDeviceListItem device, int rssi, byte[] scanRecord) {
	...
	public BTDeviceListItem getDevice(int index) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            fields.deviceSelectionStatus = (CheckBox) convertView.findViewById(R.id.checkBox);
            convertView.setTag(fields);

            fields.deviceSelectionStatus.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {

                @Override
                public void onCheckedChanged(CompoundButton buttonView, boolean state) {
                    CompoundButton cb = buttonView;
                    BTDeviceListItem btDevice = (BTDeviceListItem) cb.getTag();
        ...
        BTDeviceListItem device = mDevices.get(position);
        ...
        fields.deviceSelectionStatus.setTag(device);
